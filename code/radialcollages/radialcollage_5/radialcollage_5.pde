...
void setup () {
  ...
  Layer1_Items = generateCollageItems ("Layer1", 300, 0, height / 4, radians (360), 300, 0.08, 0.5, 0, 0);
  Layer2_Items = generateCollageItems ("Layer2", 200, 0, height / 4, radians (360), 300, 0.08, 0.3, 0, 0);
...
void keyPressed () {
  ...
  if (key == '1') Layer1_Items = generateCollageItems ("Layer1", 300, 0, height / 4, radians (360), 300, 0.08, 0.5, 0, 0);
  if (key == '2') Layer2_Items = generateCollageItems ("Layer2", 200, 0, height / 4, radians (360), 300, 0.08, 0.3, 0, 0);

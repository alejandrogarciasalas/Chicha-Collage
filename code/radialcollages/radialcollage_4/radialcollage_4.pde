...
void setup () {
  ...
  Layer1_Items = generateCollageItems ("Layer1", 100, 0, height / 4, radians (360), 350, 0.08, 0.5, 0, 0);
  Layer2_Items = generateCollageItems ("Layer2", 100, 0, height / 4, radians (360), 350, 0.08, 0.3, 0, 0);
  Layer3_Items = generateCollageItems ("Layer3", 100, 0, height / 4, radians (360), 350, 0.08, 0.1, 0, 0);
...
void keyPressed () {
  ...
  if (key == '1') Layer1_Items = generateCollageItems ("Layer1", 100, 0, height / 4, radians (360), 350, 0.08, 0.4, 0, 0);
  if (key == '2') Layer2_Items = generateCollageItems ("Layer2", 100, 0, height / 4, radians (360), 350, 0.08, 0.1, 0, 0);
  if (key == '3') Layer3_Items = generateCollageItems ("Layer3", 100, 0, height / 4, radians (360), 350, 0.08, 0.1, 0, 0);

...
void setup () {
  ...
  // ------ init ------
  Layer1_Items = generateCollageItems ("Layer1", 100, 0, height / 2, TWO_PI, height, 0.1, 0.5, 0, 0);
  Layer2_Items = generateCollageItems ("Layer2", 150, 0, height / 2, TWO_PI, height, 0.1, 0.3, -PI / 6, PI / 6);
  Layer3_Items = generateCollageItems ("Layer3", 110, 0, height / 2, TWO_PI, height, 0.1, 0.2, 0, 0);
...
void keyPressed () {
  ...
  if (key == '1') Layer1_Items = generateCollageItems ("Layer1", (int)random(50,200), 0,height/2,PI*5,height, 0.1,0.5, 0,0);
  if (key == '2') Layer2_Items = generateCollageItems ("Layer2", (int)random(25,300), 0,height*0.15,PI*5,150, 0.1,random(0.3,0.8), -PI/6,PI/6);
  if (key == '3') Layer3_Items = generateCollageItems ("Layer3", (int)random(50,300), 0,height*0.66,PI*5,height*0.66, 0.1,random(0.2,0.5), -0.05,0.05);

...
void setup () {
  ...
  Layer1_Items = generateCollageItems ("Layer1", 300, 0, height / 4, radians (360), 300, 0.08, 0.3, 45, 45);
  Layer2_Items = generateCollageItems ("Layer2", 200, 0, height / 4, radians (360), 300, 0.08, 0.2, 45, 45);
  Layer3_Items = generateCollageItems ("Layer3", 100, 0, height / 4, radians (360), 300, 0.08, 0.1, 45, 45);
...
void keyPressed () {
  ...
  if (key == '1') Layer1_Items = generateCollageItems ("Layer1", 300, 0, height / 4, radians (360), 300, 0.08, 0.3, 45, 45);
  if (key == '2') Layer2_Items = generateCollageItems ("Layer2", 200, 0, height / 4, radians (360), 300, 0.08, 0.2, 45, 45);
  if (key == '3') Layer3_Items = generateCollageItems ("Layer3", 100, 0, height / 4, radians (360), 300, 0.08, 0.1, 45, 45);

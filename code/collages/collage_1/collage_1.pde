...
void setup () {
  ...
  // ------ init ------
  Layer1_Items = generateCollageItems ("Layer1", 10, width / 2, height / 2, width, height, 0.1, 1.0, 0, 0);
  Layer2_Items = generateCollageItems ("Layer2", 10, width / 2, height / 2, width, height, 0.1, 1.0, 0, 0);
  Layer3_Items = generateCollageItems ("Layer3", 10, width / 2, height / 2, width, height, 0.1, 1.0, 0, 0);
...
void keyReleased() {
  ...
  if (key == '1') Layer1_Items = generateCollageItems ("Layer1", (int) random (1, 10), width / 2, height / 2, width, height, 0.1, 1.0, 0, 0);
  if (key == '2') Layer2_Items = generateCollageItems ("Layer2", (int) random (1, 10), width / 2, height / 2, width, height, 0.1, 1.0, 0, 0);
  if (key == '3') Layer3_Items = generateCollageItems ("Layer3", (int) random (1, 10), width / 2, height / 2, width, height, 0.1, 1.01, 0, 0);

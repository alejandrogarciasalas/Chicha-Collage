...
void setup () {
  ...
  Layer1_Items = generateCollageItems ("Layer1", 8, width / 2, height / 2, width, height, 0.1, 0.8, radians (270), radians (270));
  Layer2_Items = generateCollageItems ("Layer2", 8, width / 2, height / 2, width, height, 0.1, 0.8, 0, 0);
  Layer3_Items = generateCollageItems ("Layer3", 8, width / 2, height / 2, width, height, 0.1, 0.8, radians (45), radians (45));
...
void keyReleased() {
  ...
  if (key == '1') Layer1_Items = generateCollageItems ("Layer1", (int) random (1, 8), width / 2, height / 2, width, height, 0.1, 0.8, radians (270), radians (270));
  if (key == '2') Layer2_Items = generateCollageItems ("Layer2", (int) random (1, 8), width / 2, height / 2, width, height, 0.1, 0.8, 0, 0);
  if (key == '3') Layer3_Items = generateCollageItems ("Layer3", (int) random (1, 8), width / 2, height / 2, width, height, 0.1, 0.8, radians (45), radians (45));

...
void setup () {
  ...
  // ------ init ------  
  Layer1_Items = generateCollageItems ("Layer1", 8, width / 2, height / 2, width, height, 0.4, 1.0, radians (315), radians (315));
  Layer2_Items = generateCollageItems ("Layer2", 8, width / 2, height / 2, width, height, 0.4, 1.0, radians (135), radians (135));
...
void keyReleased() {
  ...
  if (key == '1') Layer1_Items = generateCollageItems ("Layer1", (int) random (1, 8), width / 2, height / 2, width, height, 0.4, 1.0, radians (315), radians (315));
  if (key == '2') Layer2_Items = generateCollageItems ("Layer2", (int) random (1, 8), width / 2, height / 2, width, height, 0.4, 1.0, radians (135), radians (135));

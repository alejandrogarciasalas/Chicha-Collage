...
void setup () {
  ...
  Layer2_Items = generateCollageItems ("Layer2", 8, width / 2, height / 2, width, height, 0.1, 0.8, radians (90), radians (90));
  Layer3_Items = generateCollageItems ("Layer3", 8, width / 2, height / 2, width, height, 0.1, 0.8, 0, 0);
...
void keyReleased() {
  ...
  if (key == '2') Layer2_Items = generateCollageItems ("Layer2", (int) random (1, 8), width / 2, height / 2, width, height, 0.1, 0.8, radians (90), radians (90));
  if (key == '3') Layer3_Items = generateCollageItems ("Layer3", (int) random (1, 8), width / 2, height / 2, width, height, 0.1, 0.8, 0, 0);

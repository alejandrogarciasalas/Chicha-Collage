...
void setup () {
  ...
  // ------ init ------
  Layer1_Items = generateCollageItems ("Layer1", 20, width / 2, height / 2, width, height, 0.4, 1.0, radians (315), radians (315));
  Layer2_Items = generateCollageItems ("Layer2", 20, width / 2, height / 2, width, height, 0.4, 1.0, radians (315), radians (315));
  Layer3_Items = generateCollageItems ("Layer3", 20, width / 2, height / 2, width, height, 0.4, 1.0, radians (45), radians (45));
...
void keyReleased() {
  ...
  if (key == '1') Layer1_Items = generateCollageItems ("Layer1", (int) random (1, 20), width / 2, height / 2, width, height, 0.4, 1.0, radians (315), radians (315));
  if (key == '2') Layer2_Items = generateCollageItems ("Layer2", (int) random (1, 20), width / 2, height / 2, width, height, 0.4, 1.0, radians (315), radians (315));
  if (key == '3') Layer3_Items = generateCollageItems ("Layer3", (int) random (1, 20), width / 2, height / 2, width, height, 0.4, 1.0, radians (45), radians (45));
